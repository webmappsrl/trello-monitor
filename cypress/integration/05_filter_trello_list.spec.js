describe('Not create Card', () => {
    ...
    it('Not create Card', () => {
        ...
        cy.get('#nova > div > div.content > div.px-view.py-view.mx-auto > div.relative > div.card > div.relative > div.overflow-hidden.overflow-x-auto.relative > table > tbody > tr > td:nth-child(3) > div > span > span').each(($e, index, $list) => {
            const text = $e.text()
